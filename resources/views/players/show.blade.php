      ...
      <div class="card">
        <div class="card-header">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('players.availabilities.create', $player) }}" class="btn btn-primary btn-sm">Tambah Jadwal</a>
          </div>
        </div>
        <div class="card-body">
                ...
                @if($player->availabilities->count())
                  @foreach ($player->availabilities as $availability)
                    <tr>
                      ...
                      <td>
                        <form action="{{ route('players.availabilities.destroy', [$player, $availability]) }}" method="POST" class="d-inline">
                          @csrf
                          @method('DELETE')
