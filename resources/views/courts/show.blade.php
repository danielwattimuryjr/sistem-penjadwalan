      ...
      <div class="card">
        <div class="card-header">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('courts.availabilities.create', $court) }}" class="btn btn-primary btn-sm">Tambah Jadwal</a>
          </div>
        </div>
        <div class="card-body">
                ...
                @if($court->availabilities->count())
                  @foreach ($court->availabilities as $availability)
                    <tr>
                      ...
                      <td>
                        <form action="{{ route('courts.availabilities.destroy', [$court, $availability]) }}" method="POST" class="d-inline">
                          @csrf
                          @method('DELETE')
